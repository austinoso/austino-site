  ...
  return (
    <html lang="en" className="dark">
      ...
      <body className={`${inter.variable} ${jakarta.variable} font-sans`}>
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[100] focus:px-4 focus:py-2 focus:bg-amber-500 focus:text-warm-bg focus:font-semibold focus:rounded-lg focus:text-sm focus:outline-none"
        >
