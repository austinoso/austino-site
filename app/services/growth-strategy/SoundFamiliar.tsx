    ...
    >
      <div className="max-w-3xl">
        ...
        <h2 className="font-display text-3xl sm:text-4xl md:text-[2.75rem] font-bold text-warm-white leading-[1.2] tracking-tight text-balance mb-10 sm:mb-12">
          ...
          <span className="text-stone-500">Then nothing happened.</span>
        </h2>
        ...
        <p className="text-base sm:text-lg text-stone-500 leading-relaxed mt-10 border-t border-stone-200 pt-8 text-pretty">
