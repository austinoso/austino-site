export default function SoundFamiliar() {
  const pains = [
    ...
    "Rankings move when someone is actively working them\u00A0\u2014 new content, updated pages, tracked and adjusted every month. The strategy doesn\u2019t run\u00A0itself.",
  ];
    ...
    <section data-fade className="px-6 sm:px-10 md:px-14 lg:px-20 pb-14 sm:pb-20 md:pb-24">
      <div className="max-w-2xl">
        ...
        <p className="text-base sm:text-lg text-stone-500 leading-relaxed mt-10 sm:mt-14 border-t border-stone-200 pt-8 text-pretty">
          Good news: <span className="text-warm-white font-medium">all of this is fixable.</span>
        </p>
      </div>
    </section>
  );
