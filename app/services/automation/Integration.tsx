    ...
    <section data-fade>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr] gap-8 lg:gap-0">
        ...
        <div className="lg:pr-12">
          <p className="text-xs font-mono text-stone-400 uppercase tracking-wider mb-6">
            Without integration
          </p>
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="flex items-start gap-3 group">
                <span className="text-xs font-mono text-stone-500 mt-0.5 w-5 flex-shrink-0 text-right">
                  {i + 1}.
                </span>
                <p
        ...
        <div className="lg:pl-12">
          ...
          <p className="mt-4 text-xs font-mono text-stone-400 tracking-wide">
