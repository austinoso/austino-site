const stats = [
  ...
  },
  {
    number: "3s",
    label:
      "That\u2019s how long you have before over half your visitors leave. They never see your reviews, your work, or your phone number.",
    source: {
...
const signals = [
  {
    heading: "Google\u2019s Trust Score",
    stat: "Ranking factor",
    body: "Google measures how fast, stable, and responsive your site is. A slow or janky site gets buried\u00A0\u2014 no matter how good your reviews are.",
    source: {
  ...
  {
    heading: "Mobile Is the Only Version",
    stat: "Desktop doesn\u2019t count",
    body: "Google judges your site entirely by its phone experience. If it\u2019s hard to use on mobile, you drop in results before anyone gets a chance to trust you.",
    source: {
...
/* ── Card styles ── */
const statCard =
  "rounded-xl bg-white border border-stone-200 p-6 sm:p-8 hover:shadow-md hover:border-stone-300 transition-all duration-300";
const signalCard =
  "rounded-xl bg-white border border-stone-200 border-l-[3px] border-l-[#004D3A] p-6 sm:p-8 hover:shadow-md hover:border-stone-300 hover:border-l-[#004D3A] transition-all duration-300";
    ...
    <section data-fade>
      <div className="px-6 sm:px-10 md:px-14 lg:px-20 mb-10 sm:mb-14">
        <h2 className="font-display text-3xl sm:text-4xl md:text-[2.75rem] font-bold text-white leading-[1.15] max-w-2xl">
          They searched. They clicked. Now they&apos;re{" "}
          <span className="text-emerald-300">deciding.</span>
        </h2>
        <p className="mt-4 text-[15px] text-emerald-100/70 leading-relaxed max-w-xl">
          Before anyone calls, they check you out online. Here&apos;s what decides whether they
          stay&nbsp;&mdash; or&nbsp;leave.
        </p>
      </div>
      ...
      <div className="md:hidden px-6 space-y-3 pb-6 sm:px-10">
        ...
        {signals.map((s) => (
          <div key={s.stat} className={signalCard}>
      ...
      <div className="hidden md:grid md:grid-cols-3 gap-4 px-6 sm:px-10 md:px-14 lg:px-20">
        ...
        <div className={`${signalCard} md:col-span-2 flex flex-col justify-center`}>
          <p className="text-[11px] font-mono text-stone-400 uppercase tracking-wider mb-1.5">
            {signals[0].heading}
          </p>
        ...
        <div className={`${statCard} flex flex-col justify-between`}>
          <div>
