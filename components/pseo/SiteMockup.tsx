// ── SiteMockup — legal pSEO "What You Get" bento grid ──
// Featured card with embedded browser mockup + standard deliverable cards
// + full-width growth strategy anchor. Different visual rhythm from
// the two-column sections above it.
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
        ...
        >
          ...
          <div className="bg-white px-5 py-4 sm:px-6 sm:py-5">
            ...
            {/* Practice area pills + reviews */}
            <div className="flex items-center gap-1.5 mb-2.5">
              {["Family Law", "Personal Injury", "Estate Planning"].map((a) => (
                <span
                  key={a}
            ...
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-md bg-amber-50/60 border border-amber-200/40">
              ...
              <span className="text-[9px] text-stone-500 font-medium">4.9 · 127 reviews</span>
            </div>
          </div>

          {/* Footer bar */}
          <div className="flex items-center justify-between px-5 py-2 border-t border-stone-200 bg-stone-50/60">
            <span className="text-[10px] font-mono text-stone-400">Schema: LegalService ✓</span>
            <span className="text-[10px] font-mono text-emerald-600">PageSpeed 98</span>
          </div>
        </div>
        ...
        {/* ── Row 2: first 3 remaining deliverable cards ── */}
        ...
        {/* ── Row 3: last deliverable + growth strategy ── */}
        {rest.slice(3).map((d) => {
          const Icon = d.icon;
          return (
            <div key={d.title} className={card}>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-[14px] text-stone-500 leading-relaxed">
                  ...
                  track what converts, and adjust the strategy monthly. You focus on practicing law.
                </p>
                <Link
