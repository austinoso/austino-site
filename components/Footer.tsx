...
export default function Footer({ variant = "light" }: FooterProps) {
  ...
  return (
    <footer
      className={`relative ${isDark ? "bg-[#1C1917]" : "border-t border-stone-200 bg-warm-bg"}`}
      role="contentinfo"
      ...
      <div className="max-w-[1200px] mx-auto px-6 sm:px-10 md:px-14 lg:px-20 py-14 sm:py-18 relative">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 sm:gap-8 mb-12">
          ...
          <div className="sm:col-span-2 md:col-span-1">
            ...
            >
              Give your business some bite. High-performance websites and SEO strategy that get
              local businesses found on Google.
            </p>
          </div>
        ...
        {/* Bottom Bar */}
        <div className={`pt-8 border-t ${isDark ? "border-white/[0.06]" : "border-stone-200"}`}>
          <p
            className={`text-xs text-center font-mono ${
              isDark ? "text-stone-500" : "text-stone-500"
            }`}
          >
            &copy; {currentYear} Loud Bark
          </p>
        </div>
      </div>
    </footer>
