...
export const tracyHomeServices = {
  headline: "Tracy doubled in population. Its contractor websites didn't move.",

  heroContext:
    "86 home service businesses across Tracy. Nearly half have no website. Of the 46 that do, 83% have no maps embed and half are missing their own name and address in a format Google can read. The city nearly doubled in 20 years. The online presence hasn't followed.",

  localStat: {
    value: "47%",
    label: "of Tracy contractors have no website at all",
  },

  problemHeading: "The fastest-growing city. The thinnest competition.",
  problemSubtext: "86 businesses scanned. Nearly half have no site. The other half barely show up.",
  ...
  additionalFAQ: [
    {
      q: "Is Tracy big enough for SEO to be worth it?",
      a: "Tracy has nearly 100K residents and it's one of the fastest-growing cities in the Valley. 47% of local contractors don't have a website. A well-built site can rank fast here.",
    },
  ],
};
