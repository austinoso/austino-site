...
export const stocktonLegal = {
  ...
  problemCards: [
    {
      ...
      source: { label: "austino.dev · 42-firm scan", href: "/insights/stockton-law-firm-websites" },
    },
    {
      stat: "21%",
  ...
  audit: {
    ...
    source: { label: "austino.dev · Full breakdown", href: "/insights/stockton-law-firm-websites" },
  },
